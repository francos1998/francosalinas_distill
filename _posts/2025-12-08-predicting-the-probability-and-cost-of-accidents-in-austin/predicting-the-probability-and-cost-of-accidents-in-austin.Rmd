...
![Cash Probability Hotspot Map](images/hotspotmap.png){width=110%}
...
![Performance Metrics Evaluation Data Set](images/EvalMetrics.png){width=80%}
...
![Correlation of crash rate and probability of accidents for different buckets of crash rates](images/MONO.png){width=50%}
