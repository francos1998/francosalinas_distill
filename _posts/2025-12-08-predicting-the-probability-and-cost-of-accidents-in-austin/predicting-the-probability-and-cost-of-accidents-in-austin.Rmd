...
![Cash Probability Hotspot Map](images/XGBSHAP.png){width=50%}
![Cash Probability Hotspot Map](images/EvalMetrics.png){width=80%}

![Cash Probability Hotspot Map](images/FullMetrics.png){width=40%}
![Cash Probability Hotspot Map](images/Monotonic.png){width=50%}
![Cash Probability Hotspot Map](images/hotspotmap.png){width=90%}
![Variable of importance plot](images/DeepDive.png){width=50%}
